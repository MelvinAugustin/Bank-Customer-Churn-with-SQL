...
--
-- Host: localhost    Database: churn_db
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f229cdd2-2d01-11f1-a07f-9c6b00191199:1-20';
...
CREATE TABLE `accounts` (
  ...
  `number_or_products` int DEFAULT NULL,
  `plan_type` varchar(50) DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `CreditCardOwnership` tinyint DEFAULT NULL,
  `ActiveMebership` tinyint DEFAULT NULL,
...
CREATE TABLE `activity` (
  ...
  KEY `customer_id` (`customer_id`),
  CONSTRAINT `activity_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `churn` (
  ...
  `ChurnIndicator` tinyint DEFAULT NULL,
  PRIMARY KEY (`churn_id`),
  KEY `customer_id` (`customer_id`),
  CONSTRAINT `churn_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-31  9:57:42
